...
<html lang="zxx" class="no-js" style="display: block">
	<head>
		...
		<script
			...
			nonce="bc0556dd-880d-4d90-a8bf-f1f8f5f268d4"
		></script>
		<script
			defer=""
		...
		></script>
		<script nonce="bc0556dd-880d-4d90-a8bf-f1f8f5f268d4">
			(function (w, d) {
				!(function (f, g, h, i) {
					f[h] = f[h] || {};
					f[h].executed = [];
	...
	<body style="display: block">
			...
			<div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="about-content col-lg-12">
						<h1 class="text-white">Support Teams</h1>
			...
			<div class="container">
				...
				<div class="row justify-content-center d-flex align-items-center">
					<div class="col-md-3 single-team">
						<div class="thumb">
							<img class="img-fluid" src="./Car Rentals_files/t1.jpg" alt="" />
							<div class="align-items-center justify-content-center d-flex">
								<a href="team.php#"><i class="fa fa-facebook"></i></a>
								<a href="team.php#"><i class="fa fa-twitter"></i></a>
								<a href="team.php#"><i class="fa fa-linkedin"></i></a>
							</div>
						</div>
					...
					<div class="col-md-3 single-team">
						<div class="thumb">
							<img class="img-fluid" src="./Car Rentals_files/t2.jpg" alt="" />
							<div class="align-items-center justify-content-center d-flex">
								<a href="team.php#"><i class="fa fa-facebook"></i></a>
								<a href="team.php#"><i class="fa fa-twitter"></i></a>
								<a href="team.php#"><i class="fa fa-linkedin"></i></a>
					...
					<div class="col-md-3 single-team">
						<div class="thumb">
							<img class="img-fluid" src="./Car Rentals_files/t3.jpg" alt="" />
							<div class="align-items-center justify-content-center d-flex">
								<a href="team.php#"><i class="fa fa-facebook"></i></a>
								<a href="team.php#"><i class="fa fa-twitter"></i></a>
								<a href="team.php#"><i class="fa fa-linkedin"></i></a>
					...
					<div class="col-md-3 single-team">
						<div class="thumb">
							<img class="img-fluid" src="./Car Rentals_files/t4.jpg" alt="" />
							<div class="align-items-center justify-content-center d-flex">
								<a href="team.php#"><i class="fa fa-facebook"></i></a>
								<a href="team.php#"><i class="fa fa-twitter"></i></a>
								<a href="team.php#"><i class="fa fa-linkedin"></i></a>
		...
		<script
			...
			data-cf-beacon='{"rayId":"7a07565a3b016bed","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2023.2.0","si":100}'
			crossorigin="anonymous"
		></script>
	</body>
</html>
