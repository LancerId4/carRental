...
$db = new DataBase();
if ( isset($_POST['id_car']) && isset($_POST['id_pickup']) && isset($_POST['date_pickup']) && isset($_POST['id_dropoff']) && isset($_POST['date_dropoff']) && isset($_POST['id_user']) && isset($_POST['email']) && isset($_POST['number'])) {
    if ($db->dbConnect()) {
        if ($db->bookingSubmit("tbl_booking", $_POST['id_user'], $_POST['id_car'], $_POST['id_pickup'], $_POST['date_pickup'], $_POST['id_dropoff'], $_POST['date_dropoff'], $_POST['email'], $_POST['number'])) {
                ...
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        <p class="text-white link-nav">
                            ...
                            <a href="about.php">Booking Success</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="banner-area relative" id="home">
            ...
            <div class="container">
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        <h1 class="text-white">Booking Failed</h1>
                        <p class="text-white link-nav">
                            <a href="index.php">Booking </a>
                            <span class="lnr lnr-arrow-right"></span>
                            <a href="about.php">Booking Failde</a>
                        </p>
                    </div>
                </div>
            </div>
	...
	<div class="row d-flex align-items-center justify-content-center">
		<div class="about-content col-lg-12">
			...
			<p class="text-white link-nav">
				<a href="index.php">Booking </a>
				<span class="lnr lnr-arrow-right"></span>
				<a href="about.php">All fields are required</a>
			</p>
		</div>
	</div>
</div>
