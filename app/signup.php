...
if (isset($_POST['email']) && isset($_POST['username']) && isset($_POST['password'])) {
    if ($db->dbConnect()) {
        if ($db->signUp("user_admin", $_POST['email'], $_POST['username'], $_POST['password'])) {
            ...
            <div class="container">
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        <h1 class="text-white">Sign Up Success</h1>
                        <p class="text-white link-nav">
                            <a href="index.php">Sign Up </a>
                            <span class="lnr lnr-arrow-right"></span>
                            <a href="about.php">Sign Up Success</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="banner-area relative" id="home">
            ...
            <div class="container">
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        <h1 class="text-white">Sign Up Failed</h1>
                        <p class="text-white link-nav">
                            <a href="carRental/index.html">Sign Up </a>
                            <span class="lnr lnr-arrow-right"></span>
                            <a href="about.html">Sign Up Failed</a>
                        </p>
                    </div>
                </div>
            </div>
...
<section class="banner-area relative" id="home">
    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                <h1 class="text-white">Database Connection</h1>
                <p class="text-white link-nav">
                    <a href="carRental/index.html">Sign Up </a>
                    <span class="lnr lnr-arrow-right"></span>
                    <a href="carRental/about.html">Database Connection</a>
                </p>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row d-flex align-items-center justify-content-center">
        <div class="about-content col-lg-12">
            <h1 class="text-white">All field are required</h1>
            <p class="text-white link-nav">
                <a href="carRental/index.html">Sign Up </a>
                <span class="lnr lnr-arrow-right"></span>
                <a href="carRental/about.html">All field are required</a>
            </p>
        </div>
    </div>
</div>
